...
ipcMain.handle('get-customers', (event, data) => db.getCustomers());
ipcMain.handle('insert-customer', (event, data) => db.insertCustomer(data));
ipcMain.handle('insert-purchase-order', (event, data) => db.insertPurchaseOrder(data));
ipcMain.handle('get-purchase-orders', (event) => db.getPurchaseOrders());
ipcMain.handle('insert-sales-order', (event, data) => db.insertSalesOrder(data));
ipcMain.handle('get-sales-orders', (event) => db.getSalesOrders());